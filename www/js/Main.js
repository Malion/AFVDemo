			...
			success:function(data){
				...
				if(thisConfirm){
					$.ajax({
						...
						username:"ladverlyderfactersteamin",
						password:"5KlQyb7v6Xy5pdPFgINK5cpj",
						type:'DELETE', 
						dataType:'json',
						success:function(){
	...
	$('#gameReviewForm').validate({
		...
		submitHandler: function(){
			...
			$.ajax({
				...
				dataType:"json",
				data:JSON.stringify({"_id":"games:" + newName,
				...
				error:function(response, request){console.log(response, request)},
				success:function(){
